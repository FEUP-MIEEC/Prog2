...
int teste_lista_nova()
{
	...
	if(lst->tamanho != 0)
		ERRO("tamanho da lista deveria ser 0")
...
int teste_lista_insere()
{
	...
	if(ret == NULL)
		ERRO("retorno deveria ser diferente de NULL")

	if(lst->tamanho != 3)
		ERRO("tamanho da lista deveria ser 3 depois de inserir string")
	...
	if(strcmp(lst->inicio->str, str1) != 0 || strcmp(lst->inicio->proximo->str, str2) != 0 ||
		strcmp(lst->inicio->proximo->proximo->str, str1) != 0)
		ERRO("conteudo da lista errado depois de inserir string")

	ret = lista_insere(lst, str2, lst->inicio);
	if(ret != lst->inicio)
		ERRO("retorno deveria ser apontador para o inicio")

	if(lst->tamanho != 4)
		ERRO("tamanho da lista deveria ser 4 depois de inserir string")
	...
	if(strcmp(lst->inicio->str, str2) != 0 || strcmp(lst->inicio->proximo->str, str1) != 0 || 
		...
		strcmp(lst->inicio->proximo->proximo->proximo->str, str1) != 0)
		ERRO("conteudo da lista errado depois de inserir string")

	lista_insere(lst, "prog2", NULL);

	if(lst->tamanho != 5)
		ERRO("tamanho da lista deveria ser 5 depois de inserir string")
	...
	if(strcmp(lst->inicio->proximo->proximo->proximo->proximo->str, "prog2") != 0)
		ERRO("conteudo da lista errado depois de inserir string")
	...
	lista_insere(lst, "prog2", NULL);
	if(lst->tamanho != 1)
		ERRO("tamanho da lista deveria ser 1 depois de inserir string")
	...
	if(strcmp(lst->inicio->str, "prog2") != 0)
		ERRO("conteudo da lista errado depois de inserir string")
...
int teste_lista_remove()
{
	...
	if(ret != lst->fim)
		ERRO("retorno deveria ser apontador para seguinte elemento")

	if(lst->tamanho != 4)
		ERRO("tamanho da lista deveria ser 9 depois de remover string")
	
	if(strcmp(lst->inicio->str, "a1") != 0 || strcmp(lst->inicio->proximo->str, "a2") != 0 ||
		strcmp(lst->inicio->proximo->proximo->str, "a3") != 0 || 
		strcmp(lst->inicio->proximo->proximo->proximo->str, "a5") != 0)
		ERRO("conteudo da lista errado depois de remover string")

	ret = lista_remove(lst, NULL);
	if(ret != NULL)
		ERRO("retorno deveria ser NULL com posicao invalida")
...
int teste_lista_pesquisa()
{
	...
	if(lista_pesquisa(lst,str2,INICIO) != lst->inicio->proximo->proximo->proximo->proximo)
		ERRO("pesquisa de uma string deveria retornar apontador onde se encontra") 

	if(lista_pesquisa(lst,"blabla",INICIO) != NULL)
		ERRO("pesquisa de uma string que nao existe deveria retornar NULL") 

	if(lista_pesquisa(lst,str1,FIM) != lst->inicio->proximo->proximo->proximo->proximo->proximo->proximo)
		ERRO("pesquisa de uma string deveria retornar apontador onde se encontra") 

	if(lista_pesquisa(lst,"blabla",FIM) != NULL)
		ERRO("pesquisa de uma string que nao existe deveria retornar NULL") 
...
int teste_lista_ordena()
{
	...
	if(ret != -1)
		ERRO("retorno deveria ser -1 com lista invalida")		
	...
	if(strcmp(lst->inicio->str, "aa") != 0 || strcmp(lst->inicio->proximo->str, "bb") != 0 ||
		...
		strcmp(lst->inicio->proximo->proximo->proximo->proximo->str, "zz") != 0)
		ERRO("conteudo da lista errado depois de ordenar (inicio->fim)")
	...
	if(strcmp(lst->fim->str, "zz") != 0 || strcmp(lst->fim->anterior->str, "mm") != 0 ||
		...
		strcmp(lst->fim->anterior->anterior->anterior->anterior->str, "aa") != 0)
		ERRO("conteudo da lista errado depois de inverter (fim->inicio)")
...
int teste_lista_inverte()
{
	...
	if(lst->tamanho != 5)
		ERRO("tamanho da lista não deve ser alterado")
	...
	if(strcmp(lst->inicio->str, "mm") != 0 || strcmp(lst->inicio->proximo->str, "ll") != 0 ||
		...
		strcmp(lst->inicio->proximo->proximo->proximo->proximo->str, "aa") != 0)
		ERRO("conteudo da lista errado depois de inverter (inicio->fim)")
	...
	if(strcmp(lst->fim->str, "aa") != 0 || strcmp(lst->fim->anterior->str, "bb") != 0 ||
		...
		strcmp(lst->fim->anterior->anterior->anterior->anterior->str, "mm") != 0)
		ERRO("conteudo da lista errado depois de inverter (fim->inicio)")
