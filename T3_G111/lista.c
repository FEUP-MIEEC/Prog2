...
element* novo_str(const char* valor)
{
...
element* lista_inicio(lista *lst)
{
	if(lst == NULL)
		return NULL;
	return lst->inicio;	
...
element* lista_insere(lista *lst, const char* valor, element *pos)
{
	element *curr = NULL;
...
element* lista_remove(lista *lst, element *pos)
{
	element *aux;
...
element* lista_pesquisa(lista *lst, const char* str, int origem)
{
	element *aux;
